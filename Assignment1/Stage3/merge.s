...
@r3,r12 will be used to maintain i,j where i is number of strings processed in list 1, j is the number of strings processed in list 2.
...
merge: 
	...
	mov r0,r9
	mov r1,r10
	bl compare  @branches to compare routine
	cmp r0,#0
	beq equal
	cmp r0,#1
	beq less
