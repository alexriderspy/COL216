...
stringinput2: @take in strings in a loop
	mov r0,r4
...
e2:
	...
	@if duplicate removal option is 0 then don't check for duplicates
	ldr r6,[r8,#16]
	cmp r6,#0
	beq fn

	@first has duplicates or not 
